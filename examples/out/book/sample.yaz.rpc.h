...
namespace com::book {
    namespace book_service {
        namespace get_book {
            ...
            concept c_sync_unit = !boost::di::aux::is_complete<Fn>::value
                || ::yazik::rpc::c_unary_sync_unit<Fn, Ctx::input_ref_t, Ctx::output_ref_t, Ctx>;
            template<typename Fn>
            concept c_async_unit = !boost::di::aux::is_complete<Fn>::value
                || ::yazik::rpc::c_unary_async_unit<Fn, Ctx::input_ref_t, Ctx::output_ref_t, Ctx>;
            struct SyncCall {
                constexpr static auto s_rpc_type = ::yazik::rpc::RpcUnitType::UnarySync;
                using context_t = Ctx;
                /*
                ::yazik::rpc::RpcResult<RespOk<book::Ref>> call(
                    context_t context,
            ...
            struct AsyncCall {
                ...
                using context_t = Ctx;
                /*
                ::yazik::rpc::RpcTask<RespOk<book::Ref>> call(
                    context_t context,
                    get_book_request::Ref request
                ) noexcept {
                    return ::yazik::rpc::RpcStatus::unimplemenmted()
        ...
        namespace get_books_via_author {
            ...
            template<typename Fn>
            concept c_sync_unit = !boost::di::aux::is_complete<Fn>::value
                || ::yazik::rpc::c_stream_writer_sync_unit<Fn, Ctx::input_ref_t, Ctx::output_ref_t, Ctx>;
            template<typename Fn>
            concept c_async_unit = !boost::di::aux::is_complete<Fn>::value
                || ::yazik::rpc::c_stream_writer_async_unit<Fn, Ctx::input_ref_t, Ctx::output_ref_t, Ctx>;
            struct SyncCall {
                constexpr static auto s_rpc_type = ::yazik::rpc::RpcUnitType::ServerStreamingSync;
                using context_t = Ctx;
                /*
                ::yazik::rpc::RpcGenerator<RespOk<book::Ref>> call(
                    context_t context,
            ...
            struct AsyncCall {
                ...
                using context_t = Ctx;
                /*
                ::yazik::rpc::RpcChannel<RespOk<book::Ref>> call(
                    context_t context,
                    get_book_via_author::Ref request
                ) noexcept {
                    return ::yazik::rpc::RpcStatus::unimplemenmted()
        ...
        namespace get_greatest_book {
            ...
            template<typename Fn>
            concept c_sync_unit = !boost::di::aux::is_complete<Fn>::value
                || ::yazik::rpc::c_stream_reader_sync_unit<Fn, Ctx::input_ref_t, Ctx::output_ref_t, Ctx>;
            template<typename Fn>
            concept c_async_unit = !boost::di::aux::is_complete<Fn>::value
                || ::yazik::rpc::c_stream_reader_async_unit<Fn, Ctx::input_ref_t, Ctx::output_ref_t, Ctx>;
            struct SyncCall {
                ...
                ::yazik::rpc::RpcResult<RespOk<book::Ref>> call(
                    context_t context,
                    ::yazik::rpc::RpcGenerator<RespOk<get_book_request::Ref>> request
                ) noexcept {
                    return ::yazik::rpc::RpcStatus::unimplemenmted()
                        .as_broken<contenx_t::resp_ok_t>;
                }
            ...
            struct AsyncCall {
                ...
                ::yazik::rpc::RpcTask<RespOk<book::Ref>> call(
                    context_t context,
                    ::yazik::rpc::RpcChannel<RespOk<get_book_request::Ref>> request
                ) noexcept {
                    return ::yazik::rpc::RpcStatus::unimplemenmted()
                        .as_broken_task<contenx_t::resp_ok_t>;
                }
